...
<div class="card shadow mb-4">
    <div class="card-header py-3 row">
        ...
        <h3 class="col-sm-6 d-flex justify-content-end m-0 font-weight-bold text-primary"><a class="nav-link fas fa-user-edit" href="" data-bs-toggle="modal" data-bs-target="#miModal"></a></h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
